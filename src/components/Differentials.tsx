      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-violet-950 text-violet-400 border border-violet-800/60 flex items-center justify-center font-bold">
              ★
            </div>
            <h3 className="text-base font-bold text-white">Atendimento Proativo & Consultivo</h3>
          ...
          <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
            ...
            <h3 className="text-base font-bold text-white">Foco Absoluto em Métricas de Negócio</h3>
            <p className="text-xs text-slate-300 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
            ...
            <h3 className="text-base font-bold text-white">Produção Audiovisual In-House</h3>
            <p className="text-xs text-slate-300 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
            ...
            <h3 className="text-base font-bold text-white">Transparência Total & Dashboards ao Vivo</h3>
            <p className="text-xs text-slate-300 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
            ...
            <h3 className="text-base font-bold text-white">Agilidade de Execução Sem Burocracia</h3>
            <p className="text-xs text-slate-300 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-3">
            ...
            <h3 className="text-base font-bold text-white">Equipe Multidisciplinar Especializada</h3>
            <p className="text-xs text-slate-300 leading-relaxed">
